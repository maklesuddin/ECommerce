namespace ECommerce.Migrations
{
    ...
    public partial class all_Database_ECommerce : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AdminUsers", t => t.ProductId, cascadeDelete: true)
                .ForeignKey("dbo.Products", t => t.AdminUserId, cascadeDelete: true)
                .Index(t => t.ProductId)
                ...
                c => new
                    {
                        ...
                        ProductId = c.Int(nullable: false),
                        UserId = c.Int(nullable: false),
                        DateTime = c.Time(nullable: false, precision: 7),
                        Ip = c.String(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Products", t => t.ProductId, cascadeDelete: true)
